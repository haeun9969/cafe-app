...
if (process.env.NODE_ENV === 'production') {
  apiOptions.server = 'https://haeun9969.herokuapp.com';
}

const requestOptions = {
  url: 'http://haeun9969.herokuapp.com/api/path',
  method: 'GET',
  json: {},
  qs: {
    offset: 20
...
const homelist = (req, res) => {
 ...
 lng: 127.08499172650731 ,
 lat: 36.991316368258154,  
 maxDistance: 20000    
}
  };
  ...
  if (!postdata.author || !postdata.rating || !postdata.reviewText) {
    ...
    request(
      ...
      (err, {statusCode}, body) => {
        ...
        } else if (status === 400 && name && name === 'ValiationError') {
          res.redirect(`/location/${locationid}/review/new?err=val`);
        } else {
          showError(req, res, statusCode);
        }
